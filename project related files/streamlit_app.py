...
st.markdown(
    """
    <h1 style='text-align: center;'>Welcome to ChurnSage !!</h1>
    """,
...
st.markdown(
    """
    <p style='text-align: center;'>Check all the conditions that apply to the customer</p>
    """,
    unsafe_allow_html=True
)
...
if st.button('Predict Churn'):
    ...
    if single == 1:
        op1 = "<br><br><p style='font-size:28px; font-weight:bold;'>This Customer is likely to be Churned :(</p>"
        op2 = f"<p style='font-size:20px; font-weight:bold;'>Churn Risk Score: {probability}%</p>"
    else:
        op1 = "<br><br><p style='font-size:28px; font-weight:bold;'>This Customer is likely to Continue!</p>"
        op2 = f"<p style='font-size:20px; font-weight:bold;'>Customer Retention Rate: {probability}%</p>"
